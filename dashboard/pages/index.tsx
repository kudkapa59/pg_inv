        ...
        <Container maxWidth="lg">
            <Masonry columns={2} spacing={2} sx={{ mt: 2, mb: '100px' }} >
                ...
                <CoBaCard title="The Service">
                    ...
                    <ul>
                        <li><a href="https://confluence.intranet.commerzbank.com/x/qc3eF" target="_blank" className="external-link">Here</a> you find more details about our service</li>
                    ...
                    <Typography><b>Email Contact:</b> pg_support@commerzbank.com</Typography>
                </CoBaCard>
                {/* =================================================
